...
class ResnetBlock3D(nn.Module):
    def __init__(self, *, in_channels, out_channels=None, conv_shortcut=False,
                 dropout, temb_channels=512, pad_mode='constant'):
        super().__init__()
...
class Encoder3D(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1, 2, 4, 8), num_res_blocks,
                 ...
                 resolution, z_channels, double_z=True, pad_mode='first', temporal_compress_times=4, **ignore_kwargs):
        super().__init__()
        self.ch = ch
        self.temb_ch = 0
        ...
        #                                 stride=1,
        #                                 padding=1)
        self.conv_out = CausalConv3d(block_in, 2 * z_channels if double_z else z_channels, kernel_size=3,
                                     pad_mode=pad_mode)
