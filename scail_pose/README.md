...
This dir contains the 3D pose extraction & rendering code for SCAIL.
<p align="center">
...
When processing multi-character data, we segment each character, extract their poses, and then render them together in 3D space. The multi-stage pose extraction pipeline provides robust estimations under multi-character interactions, benefiting from [NLFPose](https://github.com/isarandi/nlf)’s reliable depth estimation:
<p align="center">
