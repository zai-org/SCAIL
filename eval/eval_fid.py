...
def calculate_inception_stats(
    ...
    with open('/zhipu-data/tjy/inception-2015-12-05.pkl', 'rb') as f:
        detector_net = pickle.load(f).to(device)
...
@click.option('--seed',                 help='Random seed for selecting the images', metavar='INT', type=int, default=1, show_default=True)
