...
from mpu.initialize import get_model_parallel_rank, get_sequence_parallel_rank, get_data_parallel_rank
...
def model_parallel_cuda_manual_seed(seed, te_rng_tracker=False, inference_rng_tracker=False):
    ...
    offset = seed + 2718
    tensor_model_parallel_seed = offset + get_model_parallel_rank()
